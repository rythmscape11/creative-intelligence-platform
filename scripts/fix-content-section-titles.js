...
console.log('🔧 Fixing ContentSection title template literals...\n');
...
files.forEach(file => {
  ...
  // Replace template literal in ContentSection title prop
  const oldPattern = /title=\{\`Use the \$\{metadata\.title\}\`\}/g;
  const newValue = `title="Use the ${file.title}"`;
